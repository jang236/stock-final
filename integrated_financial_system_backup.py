...
class IntegratedFinancialSystem:
    ...
    def _load_data(self):
        ...
        try:
            ...
            print(f"✅ URL 데이터 로드: {len(self.urls_data)}개 URL")
...
def test_integrated_system():
    ...
    try:
        ...
        print(
            f"  URL 보유: {stats['companies_with_urls']:,}개 ({stats['url_coverage']*100:.1f}%)"
        )
        ...
        if companies_with_data:
            ...
            print(
                f"  추출 성공률: {financial_data['metadata']['success_rate']*100:.1f}%"
            )
            ...
            # 결과 파일 저장
            output_filename = f"complete_financial_data_{test_company}.json"
